<template>
    <div class="flex flex-col gap-6">
        ...
        <div class="w-full flex items-center lg:items-start gap-6 max-lg:flex-col h-fit">
            ...
            <div class="w-full lg:w-3/4 flex flex-col gap-6" v-if="products.length">
            ...
            <div class="w-full lg:w-3/4 rounded-xl bg-[#1d1e20] p-4 flex flex-col gap-4 items-center justify-center relative h-full" v-else>
                <p class="text-xl">Билеты не найдены...</p>
                <p class="text-lg opacity-70">Проверьте запрос или вернитесь на главную страницу</p>
                <NuxtLink to="/" class="px-4 py-2 rounded-xl bg-[#7DCCFF]">На главную</NuxtLink>
            </div>
        </div>
    </div>
